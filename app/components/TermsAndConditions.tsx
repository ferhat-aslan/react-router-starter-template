...
const TermsAndConditions: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        The laws of the Country, excluding its conflicts of law provisions, shall govern this 
      ...
      <p className="mb-4">
        If You have any dispute or disagreement about the Service, You agree to first contact 
        Us in an attempt to resolve the issue informally. We will try to connect with You to 
        resolve the issue.
      </p>
