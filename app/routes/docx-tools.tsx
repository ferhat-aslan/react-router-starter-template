  ...
  const meta = generateMeta(
    {
      ...
      image: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/docx-tools.png`,
    },
    [
      {
      ...
      {
        name: "twitter:image",
        content: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/docx-tools.png`,
      },
...
export default function DocxTools({loaderData}: Route.ComponentProps) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Keep all styles, fonts, and layouts intact
              </p>
            </div>
            <div className="text-center">
