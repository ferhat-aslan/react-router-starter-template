  ...
  const meta = generateMeta(
    ...
    [
      ...
      },
      {
        name: "keywords",
        content:
          "latex tools, latex editor, latex converter, latex to pdf, free latex tools, online latex",
      },
...
export default function LatexTools({loaderData}: Route.ComponentProps) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Render complex mathematical equations with professional quality
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Convert LaTeX documents to publication-ready PDFs
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Work with LaTeX directly in your browser
              </p>
            </div>
          </div>
        </div>
