  ...
  const meta = generateMeta(
    {
      ...
      image: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/image-tools.png`,
    },
    [
      {
      ...
      {
        name: "twitter:image",
        content: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/image-tools.png`,
      },
...
export default function ImageTools({loaderData}: Route.ComponentProps) {
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-16 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {["JPG", "PNG", "GIF", "WEBP", "BMP", "TIFF", "SVG"].map(
                (format, index) => (
                  <div
                    key={index}
