  ...
  const meta = generateMeta(
    {
      ...
      image: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/seo-tools.png`,
    },
    [
      {
      ...
      {
        name: "twitter:image",
        content: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/seo-tools.png`,
      },
...
export default function SeoTools({loaderData}: Route.ComponentProps) {
  const t = (key: string) => loaderData.messages[key] || key;
  const seoTools = [
    {
      name: t("seo.tools.keyword-analyzer.name"),
