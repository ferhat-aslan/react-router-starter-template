...
export default function IconResizer({loaderData}: Route.ComponentProps) {
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-4">
                    <button className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                      Resize Images
                    </button>
                  </div>
                </div>
          ...
          <div className="mt-16 text-center">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">
              Benefits of Properly Sized Icons
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-gray-200 dark:border-slate-700">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Optimized sizes reduce bandwidth and improve performance
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-gray-200 dark:border-slate-700">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Icons look crisp across all devices and platforms
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-gray-200 dark:border-slate-700">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Proper icons improve user experience and search rankings
                </p>
              </div>
            </div>
          </div>
