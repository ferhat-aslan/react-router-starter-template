  ...
  const meta = generateMeta(
    {
      ...
      image: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/json-tools.png`,
    },
    [
      {
      ...
      {
        name: "twitter:image",
        content: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/json-tools.png`,
      },
...
export default function JsonTools({loaderData}: Route.ComponentProps) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Your data is processed locally, never sent to servers
                </p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  All JSON tools are completely free to use
                </p>
              </div>
            </div>
          </div>
