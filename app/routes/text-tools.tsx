  ...
  const meta = generateMeta(
    {
      ...
      image: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/text-tools.png`,
    },
    [
      {
      ...
      {
        name: "twitter:image",
        content: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/text-tools.png`,
      },
...
export default function TextTools({loaderData}: Route.ComponentProps) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Your text is never stored or sent to any server
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Instant processing without any delays
                </p>
              </div>
              <div className="text-center">
