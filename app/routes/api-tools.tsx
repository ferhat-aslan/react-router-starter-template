  ...
  const meta = generateMeta(
    {
      ...
      image: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/api-tools.png`,
    },
    [
      {
      ...
      {
        name: "twitter:image",
        content: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/api-tools.png`,
      },
      {
        name: "keywords",
        content:
          "api tools, api tester, api debugger, api documentation, rest api, graphql, oauth, free api tools",
      },
...
export default function ApiTools({loaderData}: Route.ComponentProps) {
