    ...
    [
      ...
      },
      {
        "script:ld+json": course({
          ...
          description:
            "Step-by-step guide on converting PDF pages to image files",
        }),
      },
...
export default function PdfToImages({loaderData}: any) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Images are universally viewable. Share on social media,
                presentations, or anywhere.
              </p>
            </div>
            <div className="p-6 bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Convert with crisp, high-resolution output perfect for printing
                or web use.
              </p>
            </div>
            <div className="p-6 bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                All pages converted at once and delivered as a convenient ZIP
                file.
              </p>
            </div>
          </div>
        ...
        <section className="w-full max-w-4xl mx-auto mt-16 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Our tool converts each page to a high-quality image.
              </p>
            </div>
            <div className="text-center p-6">
              <div className="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Get all images in a ZIP file, ready to use.
              </p>
            </div>
          </div>
        </section>
