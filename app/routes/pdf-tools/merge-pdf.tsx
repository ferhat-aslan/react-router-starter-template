  ...
  return generateMeta(
    {
      ...
      image: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/pdf-tools/merge-pdf.png`,
    },
    [
      {
      ...
      },
      {
        "script:ld+json": course({
          ...
          description:
            "Learn how to combine multiple PDF documents into one single file securely in your browser.",
        }),
      },
...
export default function MergePdf({loaderData}: any) {
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-12">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 py-12">
          <div className="p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm transition-all hover:shadow-md">
            <div className="w-14 h-14 bg-blue-100 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center mb-6 text-blue-600 font-bold text-2xl">
              100%
            </div>
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Your sensitive documents never leave your browser. Merging happens
              entirely locally on your device using advanced client-side logic.
            </p>
          </div>
          <div className="p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm transition-all hover:shadow-md">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              We preserve original formatting, fonts, and vector elements. Your
              combined PDF will look exactly like the individual documents.
            </p>
          </div>
          <div className="p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm transition-all hover:shadow-md">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Quickly arrange your files in any sequence. The tool automatically
              handles page count detection and complex structure merging.
            </p>
          </div>
        </section>
      </div>
