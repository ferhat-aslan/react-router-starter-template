  ...
  const meta = generateMeta(
    {
      ...
      image: `https://kleinbyte.com/${locale === "en" ? "" : locale + "/"}og/pdf-tools/word-to-pdf.png`,
    },
    [
      {
...
export default function WordToPdf({loaderData}: any) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                PDF works on any device without requiring Microsoft Word or
                special software.
              </p>
            </div>
            <div className="p-6 bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                PDF maintains your exact layout, fonts, and images across all
                platforms.
              </p>
            </div>
            <div className="p-6 bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                PDF is the standard for resumes, contracts, and official
                documents.
              </p>
            </div>
          </div>
        ...
        <section className="w-full max-w-4xl mx-auto mt-16 px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6">
              <div className="w-12 h-12 bg-blue-700 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                1
              </div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Select your DOC, DOCX, or RTF file from your device.
              </p>
            </div>
            <div className="text-center p-6">
              <div className="w-12 h-12 bg-blue-700 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Click convert and we'll transform your document to PDF.
              </p>
            </div>
            <div className="text-center p-6">
              <div className="w-12 h-12 bg-blue-700 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Download your PDF, ready to share or print.
              </p>
            </div>
          </div>
        </section>
