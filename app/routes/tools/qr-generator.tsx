    ...
    [
      ...
      },
      {
        "script:ld+json": course({
          ...
          description:
            "Learn how to create custom, high-resolution QR codes securely in your browser",
        }),
      },
...
export default function QrGenerator({loaderData}: any) {
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 py-12">
          <div className="p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              No data tracking. Your URLs and text never leave your browser. All
              generation happens locally for maximum security.
            </p>
          </div>
          <div className="p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Generate QR codes in real-time as you type. Choose from multiple
              error correction levels to ensure readability.
            </p>
          </div>
          <div className="p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Download your QR codes in high-resolution PNG format, perfect for
              printing on business cards, posters, or flyers.
            </p>
          </div>
        </section>
      </div>
