...
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to [COMPANY NAME], [ADDRESS].
...
If You have any dispute or disagreement about the Service, You agree to first contact Us in an attempt to resolve the issue informally. We will try to connect with You to resolve the issue.
